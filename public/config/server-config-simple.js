...
// This is a more robust version that ensures all functions are available
...
(function() {
    ...
    const ServerConfig = {
        ...
        getLegacyAPI: function(endpoint = '') { return getCurrentConfig().legacy.base + endpoint; },
    ...
    console.log('Available functions:', Object.keys(ServerConfig).filter(key => typeof ServerConfig[key] === 'function'));
